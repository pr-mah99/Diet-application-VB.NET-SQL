...
Public Class Favorite_meals
    ...
    Private Sub sql_Code()
        Try
            Dim sql As String = "Select Favorite_id as '#',meal_name as 'اسم الوجبة',meal_type as 'نوع الوجبة',meal_desc as 'الوصف',Favorite_meals.createdate as 'تاريخ الاضافة' from Favorite_meals,Meals where Favorite_meals.meal_id=Meals.meal_id and user_id=" & Main.Label13.Text
    ...
    Private Sub fillItemName(sql As String, ItemName As ComboBox)
        ...
        Next
    End Sub
    Private Sub Favorite_meals_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub FilterData(valueToSearch As String)
        If Guna2TextBox1.Text = "" Then
            sql_Code()
        Else
            Dim searchQuery As String = "Select Favorite_id as '#',meal_name as 'اسم الوجبة',meal_type as 'نوع الوجبة',meal_desc as 'الوصف',Favorite_meals.createdate as 'تاريخ الاضافة' from Favorite_meals,Meals where user_id='" & Main.Label13.Text & "' And Favorite_meals.meal_id=Meals.meal_id And CONCAT(meal_name,meal_desc) like '%" & valueToSearch & "%'"
        ...
        Else
            Try
                If MsgBox("هل انت متاكد من حذف هذا ؟ ", MessageBoxButtons.YesNo + MessageBoxIcon.Question, "تحذير !!") = DialogResult.Yes Then
                    'Delete Code
                    Dim DeleteQuery As String = "delete from Favorite_meals where Favorite_id='" & Guna2TextBox2.Text & "'"
    ...
    Private Sub Guna2CircleButton1_Click(sender As Object, e As EventArgs) Handles Guna2CircleButton1.Click
        ...
        Else
            Try
                Dim max As Integer
                Try
                    Dim sql2 As String = "Select max(Favorite_id) from Favorite_meals"
                ...
                Finally
                    cn.Close()
                End Try
                Dim sql As String = "INSERT INTO Favorite_meals (Favorite_id,meal_id,user_id)  " _
    ...
    Private Sub Guna2CircleButton2_Click(sender As Object, e As EventArgs) Handles Guna2CircleButton2.Click
        Try
            Dim sql As String = "update Favorite_meals set meal_id='" & Guna2TextBox3.Text & "' where Favorite_id='" & Guna2TextBox2.Text & "'"
            Dim sda As New SqlDataAdapter(sql, cn)
            Dim cmd As New SqlCommand(sql, cn)
            cn.Open()
            cmd.ExecuteNonQuery()
    ...
    Private Sub Favorite_meals_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
