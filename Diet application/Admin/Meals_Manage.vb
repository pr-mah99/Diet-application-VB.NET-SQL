...
Public Class Meals_Manage
    ...
    Private Sub sql_Code()
        Try
            Dim sql As String = "Select meal_id as '#',meal_name as 'اسم الوجبة',meal_type as 'نوع الوجبة',meal_desc as 'الوصف',createdate as 'تاريخ الاضافة' from Meals"
        ...
        End Try
    End Sub
    Private Sub Meals_Manage_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        sql_Code()
    End Sub
    Public Sub FilterData(valueToSearch As String)
        If Guna2TextBox1.Text = "" Then
            sql_Code()
        Else
            Dim searchQuery As String = "Select meal_id as '#',meal_name as 'اسم الوجبة',meal_type as 'نوع الوجبة',meal_desc as 'الوصف',createdate as 'تاريخ الاضافة' from Meals where CONCAT(meal_name,meal_desc) like '%" & valueToSearch & "%'"
    ...
    Private Sub Guna2CircleButton1_Click(sender As Object, e As EventArgs) Handles Guna2CircleButton1.Click
        ...
        Else
            Try
                Dim max As Integer
                Try
                    Dim sql2 As String = "Select max(meal_id) from Meals"
                ...
                Finally
                    cn.Close()
                End Try
                Dim sql As String = "INSERT INTO Meals (meal_id,meal_name,meal_type,meal_desc)  " _
        & "VALUES ('" & max & "','" & Guna2TextBox3.Text & "','" & Guna2ComboBox1.Text & "','" & Guna2TextBox4.Text & "')"
    ...
    Private Sub Guna2CircleButton2_Click(sender As Object, e As EventArgs) Handles Guna2CircleButton2.Click
        Try
            Dim sql As String = "update Meals set meal_name='" & Guna2TextBox3.Text & "',meal_type='" & Guna2ComboBox1.Text & "',meal_desc='" & Guna2TextBox4.Text & "' where meal_id='" & Guna2TextBox2.Text & "'"
            Dim sda As New SqlDataAdapter(sql, cn)
            Dim cmd As New SqlCommand(sql, cn)
            cn.Open()
            cmd.ExecuteNonQuery()
        ...
        Else
            Try
                If MsgBox("هل انت متاكد من حذف هذا ؟ ", MessageBoxButtons.YesNo + MessageBoxIcon.Question, "تحذير !!") = DialogResult.Yes Then
                    'Delete Code
                    Dim DeleteQuery As String = "delete from Meals where meal_id='" & Guna2TextBox2.Text & "'"
    ...
    Private Sub Guna2DataGridView1_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles Guna2DataGridView1.CellClick
        ...
        Guna2ComboBox1.Text = Guna2DataGridView1.CurrentRow.Cells(2).Value.ToString()
        Guna2TextBox4.Text = Guna2DataGridView1.CurrentRow.Cells(3).Value.ToString()
    End Sub
End Class